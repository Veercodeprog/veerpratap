...
function MainHeader() {
return (
<header className="ml-10 py-5 site-header bg-white border-b-2 shadow-sm border-gray-200 inline-block w-full">
  <div className="branding">
    <Link href="/">
      <img alt="Avatar" className="avatar h-16 w-16 float-left mt-3 mr-4 rounded-md" src="/assets/veer-pratap.jpeg" />
    </Link>
  </div>
  <nav className="site-nav mt-4 clearfix">
    ...
    <ul className="list-none inline-block text-base leading-6 text-left float-left">
      ...
      <li className="inline-block mr-4">
        <Link href="https://github.com/Veercodeprog" title="Follow on GitHub">
